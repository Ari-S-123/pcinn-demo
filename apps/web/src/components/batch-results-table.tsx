...
const COLUMNS = [
  ...
  { key: "temperature_k", label: "Temp (K)", width: "w-20" },
  { key: "time_s", label: "Time (s)", width: "w-20" },
...
const columnTooltips: Partial<Record<(typeof COLUMNS)[number]["key"], string>> = {
  ...
  temperature_k: inputFieldDescriptions.temperature_k,
  time_s: inputFieldDescriptions.time_s,
